    ...
    <section class="bg-gradient-emerald-white-emerald-green vh-100 md-h-100">
        <div class="container">
            <div class="d-flex justify-content-center">
                <img width="625" height="90" src="https://www.bbconkollam.org/wp-content/uploads/2017/10/logo.jpg"
                    class="custom-logo" alt="Bishop Benziger College of Nursing"
                    srcset="https://www.bbconkollam.org/wp-content/uploads/2017/10/logo.jpg 625w, https://www.bbconkollam.org/wp-content/uploads/2017/10/logo-300x43.jpg 300w"
        ...
        <div class="container">
            ...
            <div class="row align-items-center d-flex">
                <div class="row p-5 rounded">
                    ...
                    <div class="bg-gradient-emerald-blue p-4 col-12 col-md-6">
                        <!-- Display error message here if available -->
                        @if(session('error'))
