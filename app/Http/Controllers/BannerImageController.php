    ...
    public function create()
    {
     ...
     public function store(Request $request)
     {
         $request->validate([
             ...
             'picture' => 'required|mimes:jpeg,png,jpg,gif,svg|max:2048', // Ensuring the validation is correct
         ], [
             'picture.mimes' => 'Only jpeg, png, jpg, gif, svg extensions are allowed!', // Custom error message
         ]);
         ...
         if ($request->hasFile('picture')) {
             $picture = $request->file('picture'); // Using correct input name
